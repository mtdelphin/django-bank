...
class Profile(TimeStampedModel):
    ...
    class IdentitifcationMeans(models.TextChoices):
        DRIVERS_LICENSE = (
            "drivers_license",
            _("Drivers License"),
        )
    ...
    date_of_birth = models.DateField(
        _("Date of Birth"), blank=True, null=True, default=settings.DEFAULT_BIRTH_DATE
    )
    ...
    means_of_identification = models.CharField(
        ...
        max_length=20,
        choices=IdentitifcationMeans.choices,
        default=IdentitifcationMeans.DRIVERS_LICENSE,
    )
    ...
    def save(self, *args: Any, **kwargs) -> None:
        self.full_clean()
...
class NextOfKin(TimeStampedModel):
    ...
    email_address = models.EmailField(_("Email Address"), max_length=50, db_index=True)
