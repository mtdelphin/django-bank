...
def generate_username() -> str:
    """
    Generates a unique username based on the BANK_NAME environment variable.

    Returns:
        str: A 12-character username string in the format "PREFIX-RANDOMCHARS"

    Raises:
        AttributeError: If BANK_NAME environment variable is not set (getenv returns None)
        ValueError: If the calculated remaining_length is negative (prefix too long)

    Example:
        If BANK_NAME="My Bank Name", possible output: "MBN-ABC123DEF4"
    """
